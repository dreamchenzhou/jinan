...
public class DragMenu extends HorizontalScrollView
{
	...
	private int dragMenuPaddingLeft = PADDING;
	private int dragMenuPaddingRight = PADDING;
	...
	// 左边距
	public void setDragMenuPaddingLeft(int dragMenuPaddingLeft)
	{
		this.dragMenuPaddingLeft = dragMenuPaddingLeft;
	}

	// 右边距
	public void setDragMenuPaddingRight(int dragMenuPaddingRight)
	{
		this.dragMenuPaddingRight = dragMenuPaddingRight;
	}
	...
	protected void onFinishInflate()
	{
		...
		dm_left_menu = (View) vg.getChildAt(0);
		dm_content = (View) vg.getChildAt(1);
		dm_right_menu = (View) vg.getChildAt(2);
	 ...
	 * 切换菜单
	 */
	public void switchMenu(boolean left)
	{
		if (isLeftOpen || isRightOpen)
		{
			closeMenu();
