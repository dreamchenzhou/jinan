...
package topevery.um.com.zijunlin.Zxing.Demo.camera;
...
public final class PlanarYUVLuminanceSource extends LuminanceSource
{
	...
	public byte[] getRow(int y, byte[] row)
	{
		...
		int offset = (y + top) * dataHeight + left;// dataHeight
	...
	public byte[] getMatrix()
	{
		...
		int inputOffset = top * dataHeight + left;// dataHeight
		...
		for (int y = 0; y < height; y++)
		{
			...
			inputOffset += dataHeight;// dataHeight
		}
		return matrix;
	}
